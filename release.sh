...
GH_REPO="$GH_API/repos/camflan/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/camflan/markdown-preview.nvim/releases/$id/assets?name=$filename"
